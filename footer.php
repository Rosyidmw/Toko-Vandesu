    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="https://www.instagram.com/vandesu.merch?igsh=MXJ1YW1pOTU3NWEwNA=="><i class="fab fa-instagram fs-2"></i></a>
            </div>
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="https://www.tiktok.com/@vandesumerch?_t=8nFDiCyvF7Y&_r=1"><i class="fab fa-tiktok fs-2"></i></a>
            </div>
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="https://wa.me/+6287864664125"><i class="fab fa-whatsapp fs-2"></i></a>
            </div>
        </div>
    </div>
</div>
